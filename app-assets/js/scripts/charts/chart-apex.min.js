$(function () {
  "use strict";
  var e = $(".flat-picker"),
    a = "rtl" === $("html").attr("data-textdirection"),
    o = { series1: "#826af9", series2: "#d2b0ff", bg: "#f8d3ff" },
    t = {
      series1: "#ffe700",
      series2: "#00d4bd",
      series3: "#826bf8",
  ...
  var l = document.querySelector("#column-chart"),
    d = {
      chart: { height: 400, type: "bar", stacked: !0, toolbar: { show: !1 } },
      plotOptions: {
        bar: {
          columnWidth: "15%",
          colors: {
            backgroundBarColors: [o.bg, o.bg, o.bg, o.bg, o.bg],
  ...
  var c = document.querySelector("#scatter-chart"),
    h = {
      chart: {
        height: 400,
        type: "scatter",
  ...
  void 0 !== typeof c && null !== c && new ApexCharts(c, h).render();
  var p = document.querySelector("#line-chart"),
    m = {
      chart: {
        height: 400,
        type: "line",
  ...
  void 0 !== typeof p && null !== p && new ApexCharts(p, m).render();
  var w = document.querySelector("#bar-chart"),
    u = {
  ...
  void 0 !== typeof w && null !== w && new ApexCharts(w, u).render();
  var x = document.querySelector("#candlestick-chart"),
    f = {
      chart: { height: 400, type: "candlestick", toolbar: { show: !1 } },
      series: [
        {
          data: [
      ...
      xaxis: { type: "datetime" },
      yaxis: { tooltip: { enabled: !0 }, opposite: a },
      grid: { xaxis: { lines: { show: !0 } } },
      plotOptions: {
        candlestick: {
          colors: {
  ...
  void 0 !== typeof x && null !== x && new ApexCharts(x, f).render();
  var y = document.querySelector("#heatmap-chart"),
    b = {
        ...
        heatmap: {
          ...
          colorScale: {
            ranges: [
              ...
              { from: 51, to: 60, name: "50-60", color: "#1542f8" },
            ],
          },
        },
      },
  ...
  void 0 !== typeof y && null !== y && new ApexCharts(y, b).render();
  var g = document.querySelector("#radialbar-chart"),
    S = {
  ...
  void 0 !== typeof g && null !== g && new ApexCharts(g, S).render();
  ...
  var D = document.querySelector("#donut-chart"),
    C = {
      chart: { height: 350, type: "donut" },
      legend: { show: !1 },
      labels: ["Operational", "Networking", "Hiring", "R&D"],
      series: [85, 16, 50, 50],
      colors: [t.series1, t.series5, t.series3, t.series2],
      dataLabels: {
        enabled: !0,
      ...
      responsive: [
        ...
        { breakpoint: 420, options: { legend: { show: !1 } } },
      ],
    };
  void 0 !== typeof D && null !== D && new ApexCharts(D, C).render();
});
