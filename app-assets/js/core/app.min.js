...
(window.colors = {
  ...
  (function (a, e, t) {
      ...
      t(a).on("load", function () {
        ...
        !1 === t.app.nav.initialized && t.app.nav.init({ speed: 300 }),
          ...
          t('a[data-action="reload"]').on("click", function () {
            ...
            if (n.hasClass("dark-layout")) var e = "#10163a";
            else e = "#fff";
            a.block({
    ...
    var m = t(".search-input input").data("search"),
    ...
    if (
      ...
      var z = new PerfectScrollbar(".search-list-main", {
        wheelPropagation: !1,
      });
    ...
    t(".search-list-main").mouseenter(function () {
        ...
        if (
          ...
          if (
            ...
            var o = "",
              ...
              u = "",
              f = 0;
            t.getJSON(r + "data/" + m + ".json", function (a) {
              for (var p = 0; p < a.listItems.length; p++) {
                if (
                  ("laravel" === t("body").attr("data-framework") &&
                    (a.listItems[p].url = r + a.listItems[p].url),
                  !0 === n)
                ) {
                  s = "";
                  for (
                    var m = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0;
                    v < m.length;
                    v++
                  ) {
                    if (
                      a.listItems[p].name ===
                      m[v].firstChild.dataset.originalTitle
                    ) {
                      s = " text-warning";
                      break;
                    }
                ...
                0 == a.listItems[p].name.toLowerCase().indexOf(e) &&
                  f < 5 &&
                  ((o +=
                    '<li class="auto-suggestion ' +
                    (0 === f ? "current_item" : "") +
                    ...
                    a.listItems[p].url +
                    '><div class="d-flex justify-content-start align-items-center">' +
                    feather.icons[a.listItems[p].icon].toSvg({
                      class: "mr-75 ",
                    }) +
                    "<span>" +
                    a.listItems[p].name +
              ...
              for (p = 0; p < a.listItems.length; p++) {
                if (!0 === n) {
                  s = "";
                  for (
                    m = t("ul.nav.navbar-nav.bookmark-icons li"), v = 0;
                    v < m.length;
                    v++
                  )
                    s =
                ...
                0 != a.listItems[p].name.toLowerCase().indexOf(e) &&
                  a.listItems[p].name.toLowerCase().indexOf(e) > -1 &&
                  f < 5 &&
                  ((i +=
                    '<li class="auto-suggestion ' +
                    (0 === f ? "current_item" : "") +
            ...
            for (
              var p = t("ul.nav.navbar-nav.bookmark-icons li"), v = "", g = 0;
              g < p.length;
              g++
            ) {
              0 === g ? "current_item" : "";
              var C = "";
              if (t(p[g].firstChild.firstChild).hasClass("feather")) {
                var z = p[g].firstChild.firstChild.getAttribute("class");
                (C = z.split("feather-")[1].split(" ")[0]),
                  z.split("feather-")[1].split(" ")[1];
              }
              v +=
                ...
                "<span>" +
                p[g].firstChild.dataset.originalTitle +
                "</span></div>" +
                feather.icons.star.toSvg({
                  class: "text-warning bookmark-icon float-right",
                }) +
      ...
      t(a).on("scroll", function () {
        ...
        n.hasClass("navbar-static")) &&
          (t(a).scrollTop() > 65
            ? (t(
                ".horizontal-menu:not(.dark-layout) .header-navbar.navbar-fixed"
              ).css({
                background: "#fff",
            ...
            : (t(
              ...
              t(".horizontal-menu.dark-layout .header-navbar.navbar-fixed").css(
                { background: "#161d31", "box-shadow": "none" }
              ),
              t(
                ".horizontal-menu:not(.dark-layout) .horizontal-menu-wrapper.header-navbar"
              ).css("background", "#fff"),
      ...
      t(".nav-link-style").on("click", function () {
        var a = t(this),
          e = n.hasClass("dark-layout")
            ? "dark-layout"
            : n.hasClass("bordered-layout")
            ? "bordered-layout"
            : "",
          s = t(".main-menu"),
          o = t(".header-navbar"),
          r = "",
          i = a.attr("data-prev-layout");
        "" === e || "bordered-layout" === e
          ? ((r = "dark-layout"), a.attr("data-prev-layout", e))
          : (r = i),
          n.removeClass("dark-layout bordered-layout"),
          "dark-layout" === r
            ? (n.addClass("dark-layout"),
              s.removeClass("menu-light").addClass("menu-dark"),
              o.removeClass("navbar-light").addClass("navbar-dark"),
              a
                .find(".ficon")
                .replaceWith(feather.icons.sun.toSvg({ class: "ficon" })))
            : (n.addClass(i),
              s.removeClass("menu-dark").addClass("menu-light"),
              o.removeClass("navbar-dark").addClass("navbar-light"),
              a
                .find(".ficon")
